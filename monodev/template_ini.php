...
//メインのテンプレートファイル
define('MAINFILE', "monodev_main.html");

//レスのテンプレートファイル
define('RESFILE', "monodev_main.html");

//その他のテンプレートファイル
define('OTHERFILE', "monodev_other.html");

//お絵かきのテンプレートファイル
define('PAINTFILE', "monodev_paint.html");

//カタログのテンプレートファイル
define('CATALOGFILE', "monodev_catalog.html");
