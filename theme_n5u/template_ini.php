...
//テーマ(テンプレート)のバージョン
define('TEMPLATE_VER', "v1.17.0 lot.210112.0");
...
//メインのテンプレートファイル
define('MAINFILE', "n5u_main.html");

//レスのテンプレートファイル
define('RESFILE', "n5u_main.html");

//その他のテンプレートファイル
define('OTHERFILE', "n5u_other.html");

//お絵かきのテンプレートファイル
define('PAINTFILE', "n5u_paint.html");

//カタログのテンプレートファイル
define('CATALOGFILE', "n5u_catalog.html");
